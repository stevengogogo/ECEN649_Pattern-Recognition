...
\begin{align}
    \epsilon^{0}[\psi^{*}]%
    &= \int_{\theta=0}^{\theta=2\pi}\int_{r=r^{*}}^{\infty}   \frac{1}{2\pi \sigma_{0}^2}\exp(-\frac{r^2}{2\sigma_{0}^2})drd\theta\\
    &= \frac{1}{2\pi \sigma_{0}^2}\int_{\theta=0}^{\theta=2\pi}\int_{r=r^{*}}^{\infty}   \exp(-\frac{r^2}{2\sigma_{0}^2})drd\theta\\
    &= \frac{1}{2\pi \sigma_{0}^2}\int_{\theta=0}^{\theta=2\pi}\sqrt{\frac{\pi}{2}}\sigma_{0}(1-erf(\frac{r^*}{\sqrt{2}\sigma_{0}}))d\theta\\
    &= \frac{1-erf\left(\frac{r^*}{\sqrt{2}\sigma_{0}}\right)}{2\sqrt{2\pi}\sigma_{0}}\int^{2\pi}_{\theta=0} d\theta\\ 
    &= \frac{1-erf\left(\frac{r^*}{\sqrt{2}\sigma_{0}}\right)}{2\sqrt{2\pi}\sigma_{0}}2\pi\\ 
    &= \frac{1-erf\left(\frac{r^*}{\sqrt{2}\sigma_{0}}\right)}{2\sqrt{2\pi}\sigma_{0}}2\pi\\ 
    &= \sqrt{\pi}\frac{1-erf\left(\frac{r^*}{\sqrt{2}\sigma_{0}}\right)}{\sqrt{2}\sigma_{0}}\\ 
    &= \sqrt{\frac{\pi}{2\sigma_{0}^2}}\left(1-erf(\frac{r^*}{\sqrt{2}\sigma_{0}})\right)
\end{align}
